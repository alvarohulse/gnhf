...
| `--max-tokens <n>`                 | Abort after `n` complete harness-reported input+output tokens; persists across resume              | unlimited              |
